...
def create_axi_file():
    ...
    def vector_in_centre_thetraedr(dist, v1, v2, v3, v4):
        ...
        :param v1: массив, в котором 3 элемента - координаты х,y,z точки, находящейся от центра тетраэдра на расстоянии dist[0]
        :param v2: массив, в котором 3 элемента - координаты х,y,z точки, находящейся от центра тетраэдра на расстоянии dist[1]
        :param v3: массив, в котором 3 элемента - координаты х,y,z точки, находящейся от центра тетраэдра на расстоянии dist[2]
        :param v4: массив, в котором 3 элемента - координаты х,y,z точки, находящейся от центра тетраэдра на расстоянии dist[3]
    ...
    file_name = MESH_DATA_FOLDER + '/' + OBJECT + '/' + FOLDER_NAME + '/' + MESH_FILE_NAME + '.1.vtk'
    ...
    way = VTK_DATA_FOLDER + '/' + OBJECT + '/' + FOLDER_NAME+ '/' + VECTOR_FIELD
    print way
